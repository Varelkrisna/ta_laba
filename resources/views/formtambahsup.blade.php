    ...
    <div class="container d-flex justify-content-center">
        ...
        <div class="card shadow-lg" style="width: 350px; border-radius: 20px; overflow: hidden;">
            ...
            <div class="card-body text-center bg-light">
                ...
                <input type="text" class="form-control text-center mb-2" style="border-radius: 10px;" placeholder="Masukkan Supplier">

                <label class="form-label fw-bold">PIC Supplier</label>
                <input type="text" class="form-control text-center mb-2" style="border-radius: 10px;" placeholder="Masukkan PIC supplier">
